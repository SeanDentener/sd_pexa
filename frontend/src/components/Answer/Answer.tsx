      ...
      <Stack className={styles.answerContainer} tabIndex={0}>
        ...
        <Stack horizontal className={styles.answerFooter}>
          ...
          <Stack.Item className={styles.answerDisclaimerContainer}>
            <span className={styles.answerDisclaimer}>PEXA generated responses may not always be 100% accurate. 
            <br/>Please always cross check the policy references and contact the City of Cape Town's HR helpdesk.</span>
          </Stack.Item>
